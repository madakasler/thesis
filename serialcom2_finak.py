...
from influxdb_client impott Point
        ...
        if arduino.isOpen():
            ...
            try:
                while True:
                    ...
                    swapmemory_str = swapmemory_str + str(swapmemory[0]) + "%\n"
                    diskpartitions_str =diskpartitions_str + str(diskpartitions) + "%\n"
                    netiocounters_str = netiocounters_str+ str(netiocounters[2]) + "%\n"
                    netconnections_str = netconnections_str + str(netconnections) + "%\n"
                    temperatures_str =temperatures_str + str(temperatures) + "%\n"
